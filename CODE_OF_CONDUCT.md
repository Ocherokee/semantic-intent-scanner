...
reported using GitHub's reporting and repository-moderation tools on the relevant
content or account. Do not publish sensitive personal details in a repository
issue. Repository maintainers will review conduct reports and use the moderation
...
version 2.1, available at the [official version 2.1 text][version].
